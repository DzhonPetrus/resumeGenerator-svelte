	...
	<section id="work">
		...
		<div class="item">
			...
			<div class="work_date">
				...
				<span class="endDate">
                    — {(WH.endDate === null) ? 'Current' : WH.endDate}
				</span>
			</div>
    ...
    <section id="education">
        ...
        <div class="item">
			...
			<div class="study_date">
				...
				<span class="endDate">
                    — {(EBG.endDate === null) ? 'Current' : EBG.endDate}
				</span>
			</div>
...
{#if characterRef.length > 0}
	<section id="references">
        ...
        <div class="item">
			<h3 class="work_name">
				<strong>{charRef.name}</strong>
			</h3>
				{charRef.jobTitle} <br/>
                {charRef.email} <br/>
                {charRef.contactNo} <br/>
		</div> <br/>
        {/each}
	</section>
{/if}
