        ...
        <div class="mt-8">
            <Form bind:values>
                ...
                <div class="cursor-pointer flex items-center justify-center mt-6">
                    <a on:click={() => $loginState='register'}  class="inline-flex items-center text-xs font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white">
                        <span class="ml-2">
